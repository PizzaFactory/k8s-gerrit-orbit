...
RUN wget https://gerrit-ci.gerritforge.com/job/plugin-metrics-reporter-prometheus-bazel-master-stable-3.6/lastSuccessfulBuild/artifact/bazel-bin/plugins/metrics-reporter-prometheus/metrics-reporter-prometheus.jar \
 ...
 && wget https://gerrit-ci.gerritforge.com/job/plugin-healthcheck-bazel-master-stable-3.6/lastSuccessfulBuild/artifact/bazel-bin/plugins/healthcheck/healthcheck.jar \
 && wget https://gerrit-ci.gerritforge.com/job/plugin-healthcheck-bazel-master-stable-3.6/lastSuccessfulBuild/artifact/bazel-bin/plugins/healthcheck/healthcheck.jar-version \
